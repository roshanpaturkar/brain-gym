// In Golang, we can use interfaces for creating common abstractions which can be used by multiple types by
// defining method declarations that are compatible with the interface. 
